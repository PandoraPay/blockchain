...
const BlockchainSimpleTransactionDBModel = require( "../blockchain-simple-transaction-db-model")

const {BlockchainDelegateStakeSimpleTransactionSchemaBuilt} = require('./blockchain-delegate-stake-simple-transaction-db-schema-build')

module.exports = class BlockchainDelegateStakeSimpleTransactionDBModel extends BlockchainSimpleTransactionDBModel {

    constructor(scope, schema= BlockchainDelegateStakeSimpleTransactionSchemaBuilt, data, type, creationOptions) {
