...
const {BlockchainSimpleTransactionBuiltSchema} = require('./blockchain-simple-transaction-db-schema-build')

module.exports = class BlockainSimpleTransactionDBModel extends SimpleTransactionDBModel {

    constructor(scope, schema= BlockchainSimpleTransactionBuiltSchema, data, type, creationOptions) {
