...
const {BlockchainTokenCreateSimpleTransactionDBSchemaBuilt} = require('./blockchain-token-create-simple-transaction-db-schema-build')

module.exports = class BlockchainTokenCreateSimpleTransactionDBModel extends BlockchainSimpleTransactionDBModel {

    constructor(scope, schema= BlockchainTokenCreateSimpleTransactionDBSchemaBuilt, data, type, creationOptions) {
