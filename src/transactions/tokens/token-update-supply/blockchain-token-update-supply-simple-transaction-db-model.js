...
const {BlockchainTokenUpdateSupplySimpleTransactionDBSchemaBuilt} = require('./blockchain-token-update-supply-simple-transaction-db-schema-build')

module.exports = class BlockchainTokenUpdateSupplySimpleTransactionDBModel extends BlockchainSimpleTransactionDBModel {

    constructor(scope, schema= BlockchainTokenUpdateSupplySimpleTransactionDBSchemaBuilt, data, type, creationOptions) {
