...
const {BlockDBSchemaBuilt} = require('./block-db-schema-build')

module.exports = class BlockDBModel extends DBModel {

    constructor(scope, schema = BlockDBSchemaBuilt, data, type , creationOptions){
