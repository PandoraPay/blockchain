...
const {BlockPoSDBSchemaBuilt} = require('./block-pos-db-schema-build')

module.exports = class BlockPoS extends DBModel {

    constructor(scope, schema = BlockPoSDBSchemaBuilt, data, type , creationOptions){
