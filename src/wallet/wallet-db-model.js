...
const {WalletDBSchemaBuilt} = require('./wallet-db-schema-build')

module.exports = class WalletDBModel extends DBModel {

    constructor(scope, schema = WalletDBSchemaBuilt, data, type , creationOptions){
