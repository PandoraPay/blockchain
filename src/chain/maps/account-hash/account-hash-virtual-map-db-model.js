...
const {AccountHashMapElementDBSchemaBuilt} = require( "./element/account-hash-map-element-db-schema-build")
const AccountHashMapElementDBModel = require('./element/account-hash-map-element-db-model')
...
module.exports = class AccountHashVirtualMapDBModel extends HashVirtualMapDBModel {

    constructor(scope, schema = AccountHashMapElementDBSchemaBuilt, data, type, creationOptions) {
        super(scope, schema, data, type, creationOptions);
        this._childHashMapModel = AccountHashMapElementDBModel;
    }
    ...
    async updateDelegate( publicKeyHash, delegateNonceUpdate, delegatePublicKey, delegateFee ){
        ...
        if (prevDelegate !== undefined ){
            ...
            node.delegate.delegatePublicKey = delegatePublicKey;
